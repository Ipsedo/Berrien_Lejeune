...
public class HeuristiqueFousFous {
	...
	public static Heuristique ffH4 = new Heuristique(){
		...
		public int computeHeuristique(String joueur, Partie1 partie) {
			PlateauFousFous plateau = (PlateauFousFous) partie;
			if(joueur == PlateauFousFous.JBLANC){
				return (plateau.getNbBlanc() * 32 + plateau.getNbDefense(PlateauFousFous.JBLANC)) - (plateau.getNbNoir() * 32 + plateau.getNbDefense(PlateauFousFous.JNOIR)) * 2;
			} else {
				return (plateau.getNbNoir() * 32 + plateau.getNbDefense(PlateauFousFous.JNOIR)) - (plateau.getNbBlanc() * 32 + plateau.getNbDefense(PlateauFousFous.JBLANC)) * 2;
			}
		}
